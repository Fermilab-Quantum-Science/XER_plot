...
```{r}
gp<-ggplot(active%>%filter(target_start<as.Date("2026-10-01")&target_start>as.Date("2022-07-01")&(area>10|area==1)), aes( 
  ...
  geom_text(aes(x = target_start, label = name), nudge_x=9.6, nudge_y=.4, size=1.8) +
  geom_text(aes(x = late_end, label = paste(free_float, total_float, sep='/')), nudge_x=9.6, nudge_y=.4, size=1.5) +
