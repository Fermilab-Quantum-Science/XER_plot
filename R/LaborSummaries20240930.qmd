...
filt.st<-as.Date("2024-07-01")
filt.asof<- filt.st
filt.en<-as.Date("2025-01-01")
...
#write_xlsx(tpt.FY%>% filter(FY %in% c(2024, 2025)), paste(base.path,"output/TPT_",filt.name, "_FY24_25.xlsx",sep=''))
