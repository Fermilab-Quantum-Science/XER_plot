...
all <- apply.baseline.schedule(all.orig, "BL2408BCR010")
...
activities<- activities.plot(all$all.data, start.date=as.Date('2024-08-01'),end.date=as.Date('2025-10-01'))
milestones<- milestones.plot(all$all.data, exclude.future=FALSE, earliest.date = as.Date("2024-10-01"), latest.date = as.Date("2025-10-01"))
