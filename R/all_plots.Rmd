...
activities<- activities.plot(all$all.data, start.date=as.Date('2023-03-01'),end.date=as.Date('2024-03-01'))
...
reviews<- reviews.plot(all$all.data, start.date=as.Date("2023-05-01"))
```
